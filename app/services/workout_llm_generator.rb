            ...
            sections: {
              ...
              items: {
                ...
                properties: {
                  ...
                  intensity_style:    { type: "string", enum: %w[low medium high], description: "Training intensity for this section. low=conversational pace (RPE 4-5), high reps/low load, minimal rest, long durations. medium=working pace (RPE 7-8), ~10 reps with last 2 hard, 60s rest between rounds — the default for most metcon-style work. high=near-max (RPE 9-10), low reps heavy OR sprint intervals, 120-180s rest. Optional — omit for mixed sessions where each section's style is implicit." },
