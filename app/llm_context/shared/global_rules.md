...
- Cardio-machine unit pairing — each machine supports specific units:
    - **Assault bike / echo bike**: calories or time only. Never metres (the bike doesn't measure distance meaningfully). BAD: `Assault Bike · 20-30-40-50-60 m`. GOOD: `Assault Bike · 10-15-20-25 cal` or `Assault Bike · 30s`.
