      ...
      EXAMPLES = [
        ...
        },
        {
          ...
          sections: [
            ...
            { name: "TWENTY20", format: "rounds", intensity_style: "medium", rounds: 5, rest_secs: 0,
              exercises: [
            ...
            { name: "Upper Body Strength", format: "rounds", intensity_style: "medium", rounds: 5, rest_secs: 60,
              exercises: [ { name: "Low Row", reps: 10, notes: "working weight", equipment: "dumbbells" } ] },
            { name: "Lower Body Strength", format: "rounds", intensity_style: "medium", rounds: 5, rest_secs: 60,
              exercises: [ { name: "Deadlifts", reps: 10, notes: "working weight", equipment: "barbell" } ] },
            { name: "Shoulder Burn", format: "hundred", intensity_style: "medium",
