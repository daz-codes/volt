...
| 3.12 | Transformer      | `transformer`       | `FORMAT_AFFINITY["transformer"]` (line 250), `app/llm_context/transformer.md` | Strength only: `allowed_formats: %w[rounds straight]`, `banned_exercise_patterns` for conditioning tokens. |
